...
public class CalcularNotaParametros {

        private  int firstNota;
        private  int secondNota;
        private  int finalNota;
        private  String expectedResult;

        public CalcularNotaParametros(int firstNota, int secondNota, int finalNota,String expectedResult){
        ...
        public void verify_suma_all_values(){
            ...
            String actualResult = calcularNota.notaFinal(this.firstNota, this.secondNota, this.finalNota);
